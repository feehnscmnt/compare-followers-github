...
import br.com.comparador.util.ByExtensionUtil;
...
public class StartApp {
	...
	public static void main(String[] args) throws JAXBException {
		...
		Executors.newScheduledThreadPool(1).scheduleAtFixedRate(() -> {
			...
			LOG.log(Level.INFO, LogConsoleColorsUtil.ANSI_BLACK_LOG, String.format("Você tem %s seguidores.", ByExtensionUtil.byExtension(followers.size())));
			LOG.log(Level.INFO, LogConsoleColorsUtil.ANSI_BLACK_LOG, String.format("Você segue %s perfis.", ByExtensionUtil.byExtension(following.size())));
